...
def import_github(path_name="AllLyrics_clean.txt", ui_enabled=False, write_type='both'):
    """
    ...
    if not ui_enabled:
        project_clone, branch = _onehot_login()
...
def update_github(write_bool=False, ui_enabled=False, write_type='both'):
    """
